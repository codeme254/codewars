// This solution was written by someone and I can't help but laugh 😂😂😂😭😭
// https://www.codewars.com/kata/reviews/55e807a49e59ca9d64000157/groups/59fa3c5d9aca249288000633
      ...
      for (i = 0; i < ls.length; i++) {
        for (j = i + 1; j < ls.length; j++) {
          for (n = j + 1; n < ls.length; n++) {
            for (var m = n + 1; m < ls.length; m++) {
              if (
                ls[i] + ls[j] + ls[n] + ls[m] <= t &&
                ls[i] >= 0 &&
                ls[j] >= 0 &&
                ls[n] >= 0 &&
                ls[m] >= 0
            ...
            for (m = n + 1; m < ls.length; m++) {
              for (s = m + 1; s < ls.length; s++) {
                for (var y = s + 1; y < ls.length; y++) {
                  if (
                    ls[i] + ls[j] + ls[n] + ls[m] + ls[s] + ls[y] <= t &&
                    ls[i] >= 0 &&
                    ls[j] >= 0 &&
                    ls[n] >= 0 &&
                    ls[m] >= 0 &&
              ...
              for (s = m + 1; s < ls.length; s++) {
                for (y = s + 1; y < ls.length; y++) {
                  for (var z = m + 1; z < ls.length; z++) {
                    if (
                      ls[i] + ls[j] + ls[n] + ls[m] + ls[s] + ls[y] + ls[z] <=
                        t &&
                      ls[i] >= 0 &&
                      ls[j] >= 0 &&
                      ls[n] >= 0 &&
